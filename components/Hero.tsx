    ...
    <div className="relative bg-emerald-900 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-white mb-6">
          ...
          <span className="block text-lime-400">SIVIK.</span>
        </h1>
        <p className="mt-4 text-xl text-emerald-100 max-w-lg mb-8 leading-relaxed">
          Gdzie smak spotyka zdrowie. Odkryj nasze autorskie sushi, soczyste burgery i świeże sałatki z dostawą prosto pod Twoje drzwi.
        </p>
